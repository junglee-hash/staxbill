CREATE PROCEDURE [dbo].[usp_InvoicesForExportFull] 
--	DECLARE
	@AccountId bigint, 
	@StartDate DateTime = null,
	@EndDate DateTime = null
	--,@CurrencyId bigint = 1 don't accept currency pass in null
AS
BEGIN
...
FROM dbo.FullCustomerDataByAccount(@AccountId, null, @EndDate)
...
ORDER BY i.InvoiceNumber, ps.InstallmentNumber
