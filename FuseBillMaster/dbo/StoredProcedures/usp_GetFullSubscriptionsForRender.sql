CREATE   PROCEDURE [dbo].[usp_GetFullSubscriptionsForRender]
...
;WITH DistinctBillingPeriodDefinitions AS (
	SELECT DISTINCT
...
SELECT bpd.*
  ...
  INNER JOIN DistinctBillingPeriodDefinitions ss ON ss.BillingPeriodDefinitionId = bpd.Id
