...
CREATE NONCLUSTERED INDEX [IX_SubscriptionProductPriceRange_ModifiedTimestamp_SubscriptionProductId]
    ON [dbo].[SubscriptionProductPriceRange]([ModifiedTimestamp] ASC, [SubscriptionProductId] ASC) WITH (FILLFACTOR = 100);
